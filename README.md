...
- 서버 비밀정보는 저장소에 포함하지 않습니다. 공개 웹 배포와 Steam API 연결을 확인했습니다. 예약 수집 검증 범위는 아래 문서를 참고하세요.
...
Render 유휴 중단과 게임 수집을 분리하는 Edge Function 및 Cron 구성을 추가했습니다. 운영 DB의 수집 소유권은 Edge Function으로 전환했습니다. [전환 절차와 검증 범위](docs/edge-collector.md)를 참고하세요.
